...
// Derived types for form handling (similar to Project 1)
export type NewVehicle = Omit<
  Vehicle,
  "id" | "created_at" | "updated_at" | "branch" | "status" // Exclude fields not set on creation or derived fields
> & { status?: string | null }; // status might be set optionally
